    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Modules\Filament\Contracts\FilamentServiceInterface' => \Modules\Filament\Services\FilamentService::class,
            'Modules\Order\Contracts\Repositories\V1\OrderRepository' => \Modules\Order\Repositories\V1\OrderRepository\OrderEloquentRepository::class,
            'Modules\Support\Contracts\V1\FloodService\FloodServiceInterface' => \Modules\Support\Services\V1\FloodService\FloodService::class,
            'Modules\Tenant\Contracts\Repositories\V1\TenantRepository' => \Modules\Tenant\Repositories\V1\TenantRepository\TenantEloquentRepository::class,
            'Modules\User\Contracts\Repositories\V1\UserRepository' => \Modules\User\Repositories\V1\UserRepository\UserEloquentRepository::class,
